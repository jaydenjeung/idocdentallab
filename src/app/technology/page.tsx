      ...
      <section className="bg-white px-5 py-20 md:px-8 md:py-28">
        <div className="mx-auto max-w-6xl">
          ...
          <h1 className="mb-6 font-serif text-[40px] leading-[1.05] tracking-[-1px] text-ink md:text-[56px]">
            Digital-first.<br />Every case.
          </h1>
          <p className="max-w-xl text-[15px] leading-relaxed text-ink-3">
            iDOC runs a fully digital workflow — from scan file to final restoration.
            No outsourcing. No variability. Just consistent, precise work that seats right the first time.
          </p>
        </div>
      </section>
                ...
                <div>
                  <span
                    className={`font-mono text-[11px] ${
                      i === 0 ? "text-green-400" : "text-ink-4"
                    }`}
                  >
                    {p.number}
                  </span>
                  <h2
                    className={`mt-3 font-serif text-[28px] leading-tight md:text-[32px] ${
                  ...
                  <p
                    className={`mt-1 mb-4 text-[13px] font-medium uppercase tracking-wider ${
                      i === 0 ? "text-green-400" : "text-green-700"
                    }`}
                  >
                    {p.subtitle}
                  </p>
                ...
                <div>
                  <p
                    className={`mb-4 text-[10px] font-medium uppercase tracking-widest ${
                      i === 0 ? "text-green-400/60" : "text-ink-4"
                    }`}
                  >
                    Key advantages
                  </p>
                      ...
                      <li key={point} className="flex items-start gap-3">
                        ...
                        >
                          <circle
                            ...
                            fill={i === 0 ? "rgba(74,222,128,0.1)" : "#EDF7F2"}
                          />
                          <path
                            d="M5 8l2 2 4-4"
          ...
          <div className="grid gap-12 md:grid-cols-2 md:gap-20 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={item.label}
                  className="rounded-2xl border border-surface-3 bg-white p-5"
                >
